...
export const GET_SEKOLAH_SEKITAR = '[REKAP SEKOLAH] GET_SEKOLAH_SEKITAR';



export function getSekolahSekitar(routeParams)
{

    const request = axios.get(localStorage.getItem('api_base')+'/api/Sekolah/getSekolahSekitar', {
        params: routeParams
    });
