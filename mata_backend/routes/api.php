...
Route::prefix('Pjj')->group(function () {
	Route::post('getListrikInternet', 'PjjController@getListrikInternet');
	
	Route::post('getIndexPTM', 'PjjController@getIndexPTM');
	Route::get('index_ptm', 'PjjController@getIndexPTM');
	
	Route::post('getIndexPTMSp', 'PjjController@getIndexPTMSp');
	Route::get('getIndexPTMSp', 'PjjController@getIndexPTMSp');
	Route::get('index_ptm_sp', 'PjjController@getIndexPTMSp');
	
	Route::post('getInfografisNasional', 'PjjController@getInfografisNasional');
	Route::get('infografis_nasional', 'PjjController@getInfografisNasional');
	
	Route::post('getInfografisKendala', 'PjjController@getInfografisKendala');
	Route::get('infografis_kendala', 'PjjController@getInfografisKendala');
	
	Route::post('getInfografisKlaster', 'PjjController@getInfografisKlaster');
	Route::get('infografis_laporan_covid', 'PjjController@getInfografisKlaster');
	
	Route::post('getKlasterWilayah', 'PjjController@getKlasterWilayah');
	Route::get('klaster_wilayah', 'PjjController@getKlasterWilayah');
});
...
Route::prefix('app')->group(function () {
	...
	Route::get('getWilayah', 'AppController@getWilayah');
	Route::get('loginKoreg', 'AppController@loginKoreg');
	Route::post('getGeoJsonBasic', 'AppController@getGeoJsonBasic');
	Route::post('getGeoJsonWilayah', 'AppController@getGeoJsonWilayah');
	Route::post('saveLog', 'AppController@saveLog');
});
...
Route::prefix('Sekolah')->group(function() {
	...
	Route::get('getSekolahSekitar', 'SekolahController@getSekolahSekitar');
});
...
Route::prefix('CustomQuery')->group(function() {
	Route::post('getKategoriCustomQuerySekolah', 'CustomQueryController@getKategoriCustomQuerySekolah');
	Route::post('getKategoriCustomQueryPesertaDidik', 'CustomQueryController@getKategoriCustomQueryPesertaDidik');
	Route::post('getKategoriCustomQueryDatamart', 'CustomQueryController@getKategoriCustomQueryDatamart');
	...
	Route::post('runCustomQueryPesertaDidik', 'CustomQueryController@runCustomQueryPesertaDidik');
	Route::get('runCustomQueryExcel', 'CustomQueryController@runCustomQueryExcel');
	Route::get('runCustomQueryPesertaDidikExcel', 'CustomQueryController@runCustomQueryPesertaDidikExcel');
	Route::post('runCustomQueryDatamart', 'CustomQueryController@runCustomQueryDatamart');
	Route::get('runCustomQueryDatamartExcel', 'CustomQueryController@runCustomQueryDatamartExcel');
...
Route::prefix('PMP')->group(function() {
	...
	Route::get('getRaporMutu', 'PMPController@getRaporMutu');
});
